...
#from rfplayer.protocol import create_rfplayer_connection
from .rfpprotocol import create_rfplayer_connection
...
class RfplayerCommand(RfplayerDevice):
    ...
    async def send_command(cls, device_id, action):
        """Send device command to Rfplayer and wait for acknowledgement."""
